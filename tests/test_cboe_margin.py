...
class TestMargin(unittest.TestCase):
    ...
    def test_long_options_9_months_or_less(self):
        # 23
        self.assertAlmostEqual(margin(otype='c', quantity=1, expiration=6/12, strike=125, value=5, underlying=128.5), 500)
        self.assertAlmostEqual(margin(otype='p', quantity=1, expiration=6/12, strike=430, value=5.5, underlying=433.35), 550)
    
    def test_long_options_more_than_9_months(self):
        # 24-25
        self.assertAlmostEqual(margin(otype='c', quantity=1, expiration=18/12, strike=80, value=12, underlying=78), 900)
        self.assertAlmostEqual(margin(otype='c', quantity=1, expiration=20/12, strike=1325, value=16.8, underlying=1290), 1260)
        self.assertAlmostEqual(margin(otype='p', quantity=1, expiration=2, strike=42.5, value=2), 150)
    
    def test_long_options_otc_more_than_9_months(self):
        # 26-27
        self.assertAlmostEqual(margin(otype='c', quantity=1, expiration=1, strike=75, otc=True, value=4.5, underlying=79), 350)
        self.assertAlmostEqual(margin(otype='c', quantity=1, expiration=1, strike=665, otc=True, value=11, underlying=667.34), 1041.5)
        self.assertAlmostEqual(margin(otype='c', quantity=1, expiration=1, strike=665, otc=True, value=13, underlying=663.5), 1300)
    
    def test_short_put(self):
        # 28
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=80, value=2, underlying=95), 1000)
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=20, value=1.5, underlying=19.5), 540)
    
    def test_short_put_leveraged(self):
        # 29
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=725, leverage=2, value=3, underlying=970), 14800)
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=400, leverage=3, value=15.5, underlying=390.7), 24992)
        
    def test_short_put_broad_based(self):
        # 30-31
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=410, broad=True, value=0.1, underlying=445.35), 4110)
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=430, broad=True, value=7.8, underlying=433.35), 6945.25)
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=45, broad=True, value=2.85, underlying=43.34), 935.1)
        self.assertAlmostEqual(margin(otype='p', quantity=-1, strike=390, broad=True, leverage=1.5, value=4, underlying=460), 6250)
    
    def test_short_call(self):
        # 32-35
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=120, value=8.4, underlying=128.5), 3410)
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=30, value=0.05, underlying=26.38), 268.8)
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=810, leverage=2, value=10.1, underlying=815.5), 33630)
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=1250, leverage=1.5, value=2, underlying=1050.3), 15954.5)
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=430, broad=True, value=8.7, underlying=433.35), 7370.25)
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=45, broad=True, value=1.35, underlying=43.34), 619.1)
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=370, broad=True, value=12.85, underlying=378.5), 6962.5)
        self.assertAlmostEqual(margin(otype='c', quantity=-1, strike=450, broad=True, leverage=1.5, value=3, underlying=410), 6450)
    ...
    def test_max_loss(self):
        ...
        p2 = pd.DataFrame([{'otype': 'c', 'quantity': 10, 'strike': 45, 'multiplier': 100, 'reduced': 1},
                           {'otype': 'c', 'quantity': -20, 'strike': 55, 'multiplier': 100, 'reduced': 1},
        ...
        p3 = pd.DataFrame([{'otype': 'p', 'quantity': 5, 'strike': 60, 'multiplier': 100, 'reduced': 1},
                           {'otype': 'p', 'quantity': -5, 'strike': 70, 'multiplier': 100, 'reduced': 1},
                           {'otype': 'c', 'quantity': -10, 'strike': 85, 'multiplier': 100, 'reduced': 1},
        ...
        p4 = pd.DataFrame([{'otype': 'c', 'quantity': 10, 'strike': 45, 'multiplier': 100, 'reduced': 1},
                           {'otype': 'c', 'quantity': -10, 'strike': 55, 'multiplier': 100, 'reduced': 1},
                           {'otype': 'c', 'quantity': -10, 'strike': 55, 'multiplier': 100, 'reduced': 1},
                           {'otype': 'c', 'quantity': 10, 'strike': 60, 'multiplier': 100, 'reduced': 1}])
        # 36-38
    ...
    def test_box_spread(self):        
        p1 = pd.DataFrame([{'otype': 'c', 'quantity': 1, 'strike': 535, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 19.4},
                           {'otype': 'c', 'quantity': -1, 'strike': 545, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 12.2},
                           {'otype': 'p', 'quantity': 1, 'strike': 545, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 5.3},
        ...
        p2 = pd.DataFrame([{'otype': 'c', 'quantity': 1, 'strike': 40, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 15.4},
                           {'otype': 'c', 'quantity': -1, 'strike': 50, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 7.2},
                           {'otype': 'p', 'quantity': 1, 'strike': 50, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 1.75},
        ...
        p3 = pd.DataFrame([{'otype': 'c', 'quantity': -1, 'strike': 50, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 17.3},
                           {'otype': 'c', 'quantity': 1, 'strike': 60, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 8.4},
                           {'otype': 'p', 'quantity': -1, 'strike': 60, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 1.25},
    ...
    def test_long_butterfly_spread(self):
        p1 = pd.DataFrame([{'otype': 'p', 'quantity': 1, 'strike': 540, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 5.6},
                           {'otype': 'p', 'quantity': -2, 'strike': 550, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 7.2},
        ...
        p2 = pd.DataFrame([{'otype': 'c', 'quantity': 1, 'strike': 545, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 12.4},
                           {'otype': 'c', 'quantity': -2, 'strike': 550, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 8.8},
    ...
    def test_long_condor_spread(self):
        p1 = pd.DataFrame([{'otype': 'p', 'quantity': 1, 'strike': 1050, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 47.1},
                           {'otype': 'p', 'quantity': -1, 'strike': 1075, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 55.7},
                           {'otype': 'p', 'quantity': -1, 'strike': 1100, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 66.3},
        ...
        p2 = pd.DataFrame([{'otype': 'c', 'quantity': 1, 'strike': 22.5, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 0.45},
                           {'otype': 'c', 'quantity': -1, 'strike': 25, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 0.75},
                           {'otype': 'c', 'quantity': -1, 'strike': 30, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 2.75},
    ...
    def test_short_iron_butterfly_spread(self):
        p1 = pd.DataFrame([{'otype': 'p', 'quantity': 1, 'strike': 16, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 0.1},
                           {'otype': 'p', 'quantity': -1, 'strike': 20, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 0.2},
                           {'otype': 'c', 'quantity': -1, 'strike': 20, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 7},
    ...
    def test_short_iron_condor_spread(self):
        p1 = pd.DataFrame([{'otype': 'p', 'quantity': 1, 'strike': 1000, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 32},
                           {'otype': 'p', 'quantity': -1, 'strike': 1025, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 35.1},
                           {'otype': 'c', 'quantity': -1, 'strike': 1150, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 9.4},
    ...
    def test_conversion(self):
        p1 = pd.DataFrame([{'otype': 'u', 'quantity': 100, 'value': 115},
                           {'otype': 'c', 'quantity': -1, 'strike': 110, 'expiration': 1, 'multiplier': 100, 'reduced': 1, 'value': 6.5},
        ...
        p3 = pd.DataFrame([{'otype': 'u', 'quantity': -100, 'value': 71.9},
                           {'otype': 'c', 'quantity': 1, 'strike': 75, 'expiration': 1, 'multiplier': 100, 'reduced': 1},
    ...
    def test_collar(self):
        p1 = pd.DataFrame([{'otype': 'u', 'quantity': 100, 'value': 31.75},
                           {'otype': 'p', 'quantity': 1, 'strike': 30, 'expiration': 1, 'multiplier': 100, 'reduced': 1},
